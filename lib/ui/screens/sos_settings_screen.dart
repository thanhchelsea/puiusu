...
class SOSSetingsScreen extends StatelessWidget {
  Widget itemSettingSOS(BuildContext context, String title, String des,
      String status, String jumpScreen) {
    return InkWell(
      onTap: () {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    des != null ? Language.of(context).getText(des) : "",
                    style: TextStyle(
        ...
        child: BaseScreenMethod(
          ...
          body: Container(
            ...
            child: Column(
              children: <Widget>[
                Container(
                  child: itemSettingSOS(
                    context,
                    "settings.sms_help",
                    "settings.smsdes",
                    "Enabled",
                    Routes.sosSettingSMS,
                  ),
                ),
              ],
            ),
